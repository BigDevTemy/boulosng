 ...
 <section class="container pt-4 pb-5 py-sm-5" style="background:#ccc">
                 ...
                 <div class="card card-body p-sm-5 card-light h-100">
                     <div class="row align-items-center py-3 py-sm-0">
                         <div class="col-md-4 col-xl-3 mb-4 pb-3 mb-md-0 pb-md-0 text-center text-md-start">
                             <h2 class="text-light">Auto Parts</h2>
                             <p class="fs-lg text-light opacity-70 pb-md-4">Choose the best for your bike!</p><a class="btn btn-danger" href="car-finder-catalog-grid.html">Go to shop<i class="fi-chevron-right fs-sm ms-2"></i></a>
                         </div>
                 ...
                 <div class="card card-body p-sm-5 card-light h-100">
                     <div class="row align-items-center py-3 py-sm-0">
                         <div class="col-md-6 mb-4 pb-3 mb-md-0 pb-md-0 text-center text-md-start">
                             <h2 class="text-light">24 hours Customer Support</h2>
                             <p class="fs-lg text-light opacity-70 pb-md-4"></p><a class="btn btn-danger" href="#signin-modal" data-bs-toggle="modal">Contact Us<i class="fi-chevron-right fs-sm ms-2"></i></a>
                         </div>
                         <div class="col-md-6">
