    ...
    <section class="container pb-3 pb-sm-4 pb-md-5 cta__aboutus_container">
      <div class="row align-items-center pb-5">
        <div class="col-md-7 col-lg-6 col-xl-5 offset-xl-1 text-center text-md-start mb-4 mb-md-0">
          <h2 class="text-dark mb-4">What makes our heart beat</h2>
          <p class="fs-lg text-dark opacity-70 mb-md-5 cta__aboutus_text">A great deal of priority is placed on after sales service support in terms of provision and availability of genuine spare parts backed up by professionally trained engineers and technicians because BEL is not only sales oriented, but market focused in delivering satisfaction to our customers and partners for life. This has improved our friendship with customers thereby giving BEL a competitive edge over other automotive products in the market.</p>
