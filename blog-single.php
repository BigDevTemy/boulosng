...
<body class="bg-dark fixed-bottom-btn">
    ...
    <main class="page-wrapper">
        ...
        <div class="container bg-light pt-5 pb-lg-4 my-5">
            <!-- Breadcrumb-->
            <nav class="mb-3 pb-md-1 pt-md-3" aria-label="Breadcrumb">
                <ol class="breadcrumb breadcrumb-light m-0">
                    ...
                    <li class="breadcrumb-item"><a href="car-finder-blog.html">News &amp; reviews</a></li>
                    <li class="breadcrumb-item active" aria-current="page">This Year is All About New Harley Davidson</li>
                </ol>
            </nav>
            <!-- Page title-->
            <h1 class="h2 text-light pb-3">This Year is All About New Harley Davidson</h1><img class="rounded-3" src="img/car-finder/blog/10.jpg" alt="Image">
            <div class="row mt-4 pt-3">
                <!-- Post content-->
                <div class="col-lg-8">
                    <!-- Post meta-->
                    <div class="d-flex flex-wrap border-bottom border-light pb-3 mb-4"><a class="text-uppercase text-decoration-none border-end border-light pe-3 me-3 mb-2" href="#">Reviews</a>
                        <div class="d-flex align-items-center text-light border-end border-light pe-3 me-3 mb-2"><i class="fi-calendar-alt opacity-70 me-2"></i><span>Mar 25</span></div>
                        <div class="d-flex align-items-center text-light border-end border-light pe-3 me-3 mb-2"><i class="fi-clock opacity-70 me-2"></i><span>6 min read</span></div><a class="d-flex align-items-center text-light text-decoration-none mb-2" href="#comments" data-scroll><i class="fi-chat-circle opacity-70 me-2"></i><span>3 comments</span></a>
                    </div>
                    <p class="fs-lg fw-bold text-light mb-4">Feugiat eget gravida urna placerat posuere pulvinar. Id nibh hendrerit semper urna consequat. Mauris elit tellus risus ultricies ut consequat. Tempor tellus imperdiet nec velit fames pellentesque sed sed arcu. Neque quam id pellentesque in diam in.</p>
                    <p class="text-light opacity-70">Purus ornare nisl est nec. Nunc, enim tellus pretium viverra quisque id in metus volutpat. Urna eget velit venenatis, commodo eget massa. Magna donec dictum cras nullam platea. Diam rhoncus massa lectus pellentesque tristique. Amet commodo, egestas vitae bibendum. Volutpat elit condimentum integer tortor porttitor justo vel lobortis risus. Lacinia pellentesque fermentum tellus orci mauris, velit duis eget. Commodo justo, hac ligula molestie felis, iaculis. Vitae dui at ante orci, dictum fusce. Urna, sed urna fringilla faucibus euismod aliquet nec. Quis libero, fermentum amet eu, condimentum auctor. Sit vel ipsum sem tempus gravida et. Scelerisque blandit orci, est quis. Nisi, tellus amet est nascetur habitant faucibus ornare et vivamus.</p>
                    ...
                    <!-- Video-->
                    <div class="position-relative py-4 mb-2"><a class="btn btn-icon btn-light-primary text-primary rounded-circle position-absolute start-50 top-50 translate-middle zindex-5" href="https://www.youtube.com/watch?v=yT7XYeGemUw" data-bs-toggle="lightbox" style="width: 4.5rem; height: 4.5rem;"><i class="fi-play-filled fs-sm"></i></a><img class="opacity-60 rounded-3" src="img/car-finder/blog/11.jpg" alt="Video cover"></div>
                    ...
                    <div class="pt-4 pb-5 mb-md-3">
                        <div class="d-md-flex align-items-center justify-content-between border-top border-light pt-4">
                            <div class="d-flex align-items-center me-3 mb-3 mb-md-0">
                                ...
                                <div class="d-flex flex-wrap"><a class="btn btn-xs btn-translucent-light rounded-pill fs-sm fw-normal me-2 mb-2" href="#">Reviews</a><a class="btn btn-xs btn-translucent-light rounded-pill fs-sm fw-normal me-2 mb-2" href="#">Bikes</a><a class="btn btn-xs btn-translucent-light rounded-pill fs-sm fw-normal mb-2" href="#">Harley Davidson</a></div>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="text-light fw-bold text-nowrap pe-1 mb-2">Share:</div>
                                <div class="d-flex"><a class="btn btn-icon btn-translucent-light btn-xs rounded-circle mb-2 ms-2" href="#" data-bs-toggle="tooltip" title="Share with Facebook"><i class="fi-facebook"></i></a><a class="btn btn-icon btn-translucent-light btn-xs rounded-circle mb-2 ms-2" href="#" data-bs-toggle="tooltip" title="Share with Twitter"><i class="fi-twitter"></i></a><a class="btn btn-icon btn-translucent-light btn-xs rounded-circle mb-2 ms-2" href="#" data-bs-toggle="tooltip" title="Share with LinkedIn"><i class="fi-linkedin"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <!-- Comments-->
                    ...
                    <div class="offcanvas offcanvas-end offcanvas-collapse bg-dark" id="blog-sidebar">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="card card-flush bg-transparent border-light mb-4">
                                <div class="card-body">
                                    <div class="d-flex align-items-start pt-3 pt-lg-0"><img class="rounded-circle" src="img/avatars/32.jpg" width="80" alt="Kristin Watson">
                                        <div class="ps-3">
                                            <h3 class="h5 text-light mb-2">Kristin Watson</h3>
                                            <p class="fs-sm text-light opacity-70">Chief Editor at Finder</p>
                                            <div class="d-flex"><a class="btn btn-icon btn-translucent-light btn-xs rounded-circle me-2" href="#"><i class="fi-facebook"></i></a><a class="btn btn-icon btn-translucent-light btn-xs rounded-circle me-2" href="#"><i class="fi-twitter"></i></a><a class="btn btn-icon btn-translucent-light btn-xs rounded-circle me-2" href="#"><i class="fi-linkedin"></i></a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-flush bg-transparent border-light mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-start border-bottom border-light pb-3 mb-3"><a class="flex-shrink-0" href="#"><img class="rounded-3" src="img/car-finder/blog/th01.jpg" width="80" alt="Image"></a>
                                        <div class="ps-3"><a class="fs-xs text-uppercase text-primary text-decoration-none" href="#">Travel</a>
                                            <h4 class="fs-base text-light pt-1 mb-2"><a class="nav-link" href="#">Across Arctic on Old Good Land Rover Defender</a></h4>
                                            <div class="d-flex fs-xs text-light opacity-70"><span class="me-2 pe-1"><i class="fi-calendar-alt opacity-70 mt-n1 me-1 align-middle"></i>May 08</span><span><i class="fi-chat-circle opacity-70 mt-n1 me-1 align-middle"></i>4 comments</span></div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-start border-bottom border-light pb-3 mb-3"><a class="flex-shrink-0" href="#"><img class="rounded-3" src="img/car-finder/blog/th02.jpg" width="80" alt="Image"></a>
                                        <div class="ps-3"><a class="fs-xs text-uppercase text-primary text-decoration-none" href="#">Reviews</a>
                                            <h4 class="fs-base text-light pt-1 mb-2"><a class="nav-link" href="#">First ATV from KTM. Test Drive in Sahara</a></h4>
                                    ...
                                    <div class="d-flex align-items-start"><a class="flex-shrink-0" href="#"><img class="rounded-3" src="img/car-finder/blog/th03.jpg" width="80" alt="Image"></a>
                                        <div class="ps-3"><a class="fs-xs text-uppercase text-primary text-decoration-none" href="#">Reviews</a>
                                            <h4 class="fs-base text-light pt-1 mb-2"><a class="nav-link" href="#">All New Aston Martin Superleggera</a></h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tns-carousel-wrapper">
                                        <div class="tns-carousel-inner d-block" data-carousel-options="{&quot;nav&quot;: false, &quot;gutter&quot;: 20, &quot;autoHeight&quot;: true, &quot;controlsContainer&quot;: &quot;#externalControls&quot;}">
                                            <article><a class="d-block position-relative mb-3" href="#"><img class="d-block rounded-3" src="img/car-finder/blog/04.jpg" alt="Post image"></a><a class="fs-xs text-uppercase text-decoration-none" href="#">Automotive News</a>
                                                <h3 class="fs-base text-light pt-1"><a class="nav-link" href="#">Volkswagen: Never Done Innovating</a></h3><a class="d-flex align-items-center text-decoration-none" href="#"><img class="rounded-circle" src="img/avatars/08.jpg" width="44" alt="Darrell Steward">
                                                    <div class="ps-2">
                                            ...
                                            <article><a class="d-block position-relative mb-3" href="car-finder-blog-single.html"><img class="d-block rounded-3" src="img/car-finder/blog/08.jpg" alt="Post image"></a><a class="fs-xs text-uppercase text-decoration-none" href="#">Automotive News</a>
                                                <h3 class="fs-base text-light pt-1"><a class="nav-link" href="car-finder-blog-single.html">Closer Look at Electric Bike Startup</a></h3><a class="d-flex align-items-center text-decoration-none" href="#"><img class="rounded-circle" src="img/avatars/07.jpg" width="44" alt="Cody Fisher">
                                                    <div class="ps-2">
                                                        <h6 class="fs-sm text-light lh-base mb-1">Cody Fisher</h6>
...
<!-- Mirrored from finder.createx.studio/car-finder-blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Aug 2021 15:18:16 GMT -->
